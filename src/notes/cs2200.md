...
The final automata has the cartesian product of the two sets of states as the set of states (Q) and the delta is also from Q1 x Q2 to Q1 x Q2. The set of final states is Q1 x F2 union Q2 x F1
